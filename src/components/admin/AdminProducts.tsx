          ...
          <Card key={p.id}>
            <CardContent className="flex items-center gap-4 p-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button variant="ghost" size="icon" onClick={() => toggleVisibility(p)} title={p.visible ? "Hide" : "Show"}>
                  {p.visible ? <Eye className="h-4 w-4" /> : <EyeOff className="h-4 w-4" />}
                </Button>
                <Button variant="ghost" size="icon" onClick={() => toggleStock(p)} title="Toggle stock">
                  <Badge variant={p.out_of_stock ? "destructive" : "default"} className="text-[10px]">
                    {p.out_of_stock ? "OOS" : "In"}
                  </Badge>
                </Button>
