...
export default function Register() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    toast.success("Welcome to The Rejoice Collection!");
    navigate("/");
    setGoogleLoading(false);
  };
      ...
      <Card className="w-full max-w-md glass-card border-0 animate-fade-in">
        ...
        <CardContent className="space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2"><Label>Full Name *</Label><Input value={fullName} onChange={e => setFullName(e.target.value)} placeholder="Your full name" required className="glass" /></div>
            <div className="space-y-2"><Label>Email *</Label><Input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="your@email.com" required className="glass" /></div>
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-2"><Label>State</Label><Input value={state} onChange={e => setRegState(e.target.value)} placeholder="Lagos" className="glass" /></div>
            </div>
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-2"><Label>Address</Label><Input value={address} onChange={e => setAddress(e.target.value)} placeholder="Home address" className="glass" /></div>
            </div>
            <div className="space-y-2"><Label>Password *</Label><Input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Min 6 characters" required className="glass" /></div>
